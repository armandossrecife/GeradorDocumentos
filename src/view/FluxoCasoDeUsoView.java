 ...
 */
public class FluxoCasoDeUsoView extends javax.swing.JPanel {
    ...
    public FluxoCasoDeUsoView() {
        initComponents();
    }

    FluxoCasoDeUsoView(JPanel pai) {
        this.pai = pai;
        initComponents();
    ...
    private void initComponents() {
        ...
        fluxoPrincipal.setRows(4);
        fluxoPrincipal.setToolTipText("Pressione ESC para voltar À tela de Casos de uso!");
        fluxoPrincipal.setMinimumSize(new java.awt.Dimension(104, 100));
        fluxoPrincipal.setName(""); // NOI18N
        fluxoPrincipal.setPreferredSize(new java.awt.Dimension(164, 100));
