...
//            }
//            if (objeto instanceof TipoTabela) {
//                TipoTabela no = (TipoTabela) objeto;
//                return null;
//            }
//
//            if (valorNo != Constantes.TERMO_NAO_ENCONTRADO_NAS_SECOES) {
//                return null;
//            }
    ...
    private DefaultMutableTreeNode copy(TreeNode node) {
        DefaultMutableTreeNode temp = new DefaultMutableTreeNode(node);
        DefaultMutableTreeNode temp1 = (DefaultMutableTreeNode) node;
        temp.setUserObject(temp1.getUserObject());
        return temp;
    }
