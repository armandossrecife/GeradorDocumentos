...
final class Dictionary extends DictionaryBase {
    ...
    /**
     * Create an Dictionary from a serialize Dictionary. This is used from the
     * DictionaryFactory.
     *
     * @see #toArray()
    ...
    /**
     * Save this dictionary to the OutputStream. The data will be compressed.
     * After finish the OutputStream is closed.
     *
    ...
    /**
     * Trims the capacity of this <tt>Dictionary</tt> instance to be the current
     * size. An application can use this operation to minimize the storage of an
     * <tt>Dictionary</tt> instance. The load methods already call it.
     */
    void trimToSize() {
    ...
    /**
     * Create a new node at end of the array. On the current idx position is
     * writing the pointer. The pointer on the current idx position must be 0
     * without some word end flags (0x8000 on idx+1)
     *
