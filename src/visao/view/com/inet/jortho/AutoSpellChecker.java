...
/**
 * This class check a
 * <code>JTextComponent</code> automatically (in the background) for
 * orthography. Spell error are highlighted with a red zigzag line.
 *
...
class AutoSpellChecker implements DocumentListener, LanguageChangeListener {
    ...
    /**
     * Refresh the highlighting. This can be useful if the dictionary was
     * modify.
     *
     * @param text the JTextComponent
     */
     ...
     *
     * @param element the to checking Element
     */
    ...
    /**
     * // * Check the completely text. Because this can consume many times with
     * large Documents that this will do in a thread in the background step by
     * step.
     */
