...
public class CheckerListener implements PopupMenuListener, LanguageChangeListener {
     ...
     *
     * @param jText current JTextComponent
     * @param begOffs offset of the current word in the JTextComponent, need for
     * replacement
     * @param endOffs end of the current word in the JTextComponent, need for
     * replacement
     * @param list a list with suggestions
     * @param needCapitalization if the first letter of the suggestion should
     * capitalized
     */
    ...
    /**
     * Add the menu item "Add to Dictionary" at the end of the menu if a user
     * dictionary is available.
     *
     * @param jText current JTextComponent
     * @param word current word, which can be add
     * @param addSeparator true, add a separator before the menu item
     */
