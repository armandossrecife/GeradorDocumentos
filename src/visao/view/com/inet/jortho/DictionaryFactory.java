...
/**
 * With the DictionaryFactory you can create / load a Dictionary. A Dictionary
 * is list of word with a API for searching. The list is saved internal as a
 * tree.
 *
 * @see Dictionary
...
class DictionaryFactory {
     ...
     * The words must be delimmited with newlines. This method can be called
     * multiple times.
     *
    ...
    /**
     * Create from the data in this factory a Dictionary object. If there are no
     * word added then the Dictionary is empty. The Dictionary need fewer memory
     * as the DictionaryFactory.
     *
