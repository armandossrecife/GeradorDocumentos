...
abstract class DictionaryBase {
    ...
    /**
     * Es wird nach verschiedenen Regeln nach ï¿½hnlichen Wï¿½rtern gesucht. Je
     * nach Regel gibt es einen anderen diff. Jekleiner der diff desto
     * ï¿½hnlicher. Diese Methode ruft sich rekursiv auf.
     *
     * @param list Kontainer fï¿½r die gefundenen Wï¿½rter
     * @param chars bis zur charPosition bereits gemappte Buchstaben, danach
     * noch zu mappende des orignal Wortes
     * @param charPosition Zeichenposition im char array
     * @param lastIdx Position im Suchindex der zur aktuellen Zeichenposition
     * zeigt.
    ...
    /**
     * Search if the character exist in the current node. If found then the
     * variable
     * <code>idx</code> point to the location. If not found then it point on the
     * next character (char value) item in the node.
     *
    ...
    /**
     * Returns an int that describe the dissimilarity of the characters. The
     * value is ever larger 0. A value of means only a small difference.
     *
     * @param a first char
     * @param b second char
