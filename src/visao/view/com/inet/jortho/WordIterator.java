...
/**
 * A implementation of an Iterator which split a large text into lines. It is
 * used to read words lists.
 *
...
public class WordIterator implements Iterator<String> {
    ...
    /**
     * Load the directory from plain a list of words. The words must be
     * delimmited with newlines.
     *
     * @param stream a InputStream with words
     * @param charsetName the name of a codepage for example "UTF8" or "Cp1252"
     * @throws IOException If an I/O error occurs.
     * @throws NullPointerException If stream or charsetName is null.
     */
