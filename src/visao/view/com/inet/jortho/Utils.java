...
class Utils {
    ...
    /**
     * Translate a GUI string in one of the supported languages. If the value
     * was not find then the key is returned.
     *
    ...
    /**
     * Create a String with inverted case for the first letter. If it is
     * lowercase then it will change to uppercase and vice versa.
     *
     * @param word the word that should be change
     * @return the new String if needed
     */
    ...
    /**
     * Check if all letter are uppercase. Character that are not letters are
     * ignored.
     *
