...
/**
 * A hash list of Suggestions. The list is cut with a max dissimilarity. If a
 * suggestion already exist then the suggestion with the lower dissimilarity
 * will be hold.
 *
...
class Suggestions {
    ...
    /**
     * Create a suggestions list. Suggestion with a larger dissimilarity can not
     * be added.
     *
    ...
    /**
     * Get the max dissimilarity. Suggestion with a larger value can not be
     * added.
     *
     * @return
     */
