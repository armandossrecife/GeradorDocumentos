...
class DictionaryEditDialog extends JDialog {
    ...
    DictionaryEditDialog(JDialog parent) {
        super(parent, Utils.getResource("Dicionário atual"), true);
    ...
    /**
     * A hack for the layout manger to prevent that the dialog is to small to
     * show the title line. The problem occur only if there are small words in
     * the list. With a empty list there are no problems.
     */
    @Override
    ...
    private class DeleteAction extends AbstractAction {
        ...
        /**
         * Delete the selected entries. The "Delete" Button it the only
         * Listener.
         */
        @Override
        public void actionPerformed(ActionEvent e) {
