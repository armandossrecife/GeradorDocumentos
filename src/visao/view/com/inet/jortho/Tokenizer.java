...
class Tokenizer {
     ...
     * @param locale the used Locale, is needed for the word and sentence
     * breaker
    ...
    /**
     * Check if the word is a web address. This means a email address or web
     * page address.
     *
     * @param word the word that should be check. It can not be null and can not
    ...
    /**
     * Call sentences.setText( String ) based on the current value of
     * paragraphOffset.
     */
    ...
    /**
     * Update the text after a word was replaced. The changes in the text should
     * be only after the current word offset.
     */
    void updatePhrase() {
