...
/**
 * How to use <li>Download the latest Wiktionary file "pages_articles.xml". It
 * is typical compressed. The position changed. I found it last at: <ul>
 ...
 * </ul> </li>
 *
 * <li>start the Generator with follow command line:<br> java -Xmx256m
 * com.inet.spell.wiktionary.BookGenerator de <folder with file></li>
 *
 * @author Volker
 */
public abstract class BookGenerator {
     ...
     * @return erstes vorkommen einer der Zeichen in chars oder -1, wenn nicht
     * gefunden.
     */
    ...
    /**
     * Prï¿½ft ob es sich um ein gï¿½ltiges Word handelt. Damit kï¿½nnen
     * bestimmte Hilfsthemen und Phrasen ausgeschlossen werden.
     *
    ...
    /**
     * Check if a word is a valid word of the current language. With function
     * getBook().addWord() you can add additional Flexion of the word. The
     * current word self does not need added.
     *
