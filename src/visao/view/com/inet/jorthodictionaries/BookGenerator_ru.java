...
/**
 * All String include kyrillic charcters. If you have not a kyrillic keyboard
 * then only copy and paste it. Do not enter any string with a latin keyboard
 *
...
public class BookGenerator_ru extends BookGenerator {
    ...
    /**
     * Find the placholder of templates and add the words that was build with
     * this templates.
     */
    ...
    public class Template {
        ...
        /**
         * get the count of found rules in the template. Only templates with
         * rules make sence.
         */
        int getRuleCount() {
            return rules.size();
        ...
        /**
         * Create a Java source code representation of this template. Currently
         * obsolet.
         */
        @Override
