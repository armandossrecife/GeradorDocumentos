...
public class BookGenerator_de extends BookGenerator {
    ...
    /**
     * Get the chapter on the current position. If a next chapter line is not
     * find then the completely wikiText is return.
     *
     * @param wikiText
    ...
    /**
     * Liefert einen Substring mit der aktuellen Konjugation/Flektion Tabelle
     * des Wikitextes
     */
    ...
    /**
     * Die Flextionen und Konjugationen eines Wortes sind durch bestimmte
     * Phrasen gemarked.
     *
    ...
    /**
     * Substantive sind alle mit Artikel abgelegt und einige Verben zerfallen
     * bei der Konjugation
     */
     ...
     * http://de.wiktionary.org/wiki/Vorlage:Deklinationsseite_Adjektiv A sample
     * can see at
     * http://de.wiktionary.org/w/index.php?title=hoch_%28Deklination%29&action=edit
     *
     * @param wikiText
     * @param idx
     */
    ...
    private boolean addDeklinationSubstTable(String wikiText, int fromIndex, String baseWord) {
        String[] templates = {"Substantiv-Tabelle", "Substantiv-Tabelle (2 Pluralformen)",
        ...
        String[] keyWords = {"Wer oder was? (Einzahl)", "Wessen? (Einzahl)", "Wem? (Einzahl)", "Wen? (Einzahl)",
    ...
    /**
     * Implementation of the template
     * http://de.wiktionary.org/wiki/Vorlage:Deutsch_Substantiv_m_stark and
    ...
    /**
     * Implementation of the template
     * http://de.wiktionary.org/wiki/Vorlage:Deutsch_Substantiv_m_schwach_1
     */
    ...
    /**
     * Implementation of the template
     * http://de.wiktionary.org/wiki/Vorlage:Deutsch_Substantiv_m_schwach_3
     */
    ...
    /**
     * Implementation of the template
     * http://de.wiktionary.org/wiki/Vorlage:Deutsch_Substantiv_f_stark
     */
