...
public class BookGenerator_es extends BookGenerator {
    ...
    boolean isValidLanguage(String word, String wikiText) {
        ...
        findRuleAndAddWords(word, wikiText, "inflect.es.adj.-Ã³n", null, new String[]{"Ã³n", "ona", "ones", "onas"});
        findRuleAndAddWords(word, wikiText, "inflect.es.adj.ad-lib", null, new String[]{""}, new String[]{""}, new String[]{""}, new String[]{""});
        findRuleAndAddWords(word, wikiText, "inflect.es.adj.no-gÃ©nero", new String[]{"s"});
        findRuleAndAddWords(word, wikiText, "inflect.es.adj.no-gÃ©nero", new String[]{"es"});
        ...
        findRuleAndAddWords(word, wikiText, "inflect.es.sust.-Ã³n", null, new String[]{"Ã³n", "ones"});
